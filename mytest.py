...
#
# key=20
# ArnoldCatEncryptionIm = ArnoldCatEncryption("cancer.jpg", key)
...
def ArnoldCatDecryption(imageName, key):
    ...
    for i in range(decrypt_it,key):
        img = ArnoldCatTransform(img, i)
    cv2.imwrite(imageName.split('_')[0] + "_ArnoldcatDec.png",img)
    return img


ArnoldCatDecryptionIm = ArnoldCatDecryption("cancer_ArnoldcatEnc.png", 20)
print(ArnoldCatDecryptionIm)